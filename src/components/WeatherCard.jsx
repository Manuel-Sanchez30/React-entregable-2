    ...
    return (
        <article className="weather">
            ...
            <section className="weather__body">
                <div className="weather__img__container">
                ...
                <div className="weather__info">
                    ...
                    <ul className="weather__list">
                        <li className="weather__list-item"><span className="weather__list-label">Wind Speed </span><span className="weather__list-value">{weather?.wind.speed} m/s</span></li>
